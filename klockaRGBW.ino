...
Senast ändrad: 2023-09-30 16:02
*/
/*
!!!KNAPP INSTRUKTIONER!!!
...
void ClockStart()
{
  ...
  for(int led = 0; led < (floor((strip.numPixels() / 2)) + 10); led++)
  {
    ...
    strip.setPixelColor((NUM_LEDS - led), ledColors[currentColor][0], ledColors[currentColor][1], ledColors[currentColor][2], strip.gamma8(ledColors[currentColor][3]));
    delay(5);
    strip.show();
    delay(25);
  }
